...
public class PlayerController {
    ...
    public ResponseEntity<ApiResponse<PlayerJoinResponse>> registerPlayer(
        ...
        return ResponseEntity.ok(ApiResponse.success(playerService.registerPlayer(entryCode, member)));
    }
    ...
    public ResponseEntity<ApiResponse<RoomListResponse>> getRooms(
        ...
        return ResponseEntity.ok(ApiResponse.success(playerService.getRooms(member)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> leaveRoom(
        ...
        playerService.leaveRoom(entryCode, member);
