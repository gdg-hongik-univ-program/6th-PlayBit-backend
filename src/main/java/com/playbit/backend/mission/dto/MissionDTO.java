...
public record MissionDto(
        ...
        @Schema(description = "완료 시각", example = "2026-08-03T15:26:55.488320")
                LocalDateTime completedAt,
        @Schema(
                        description = "미션 인증 사진 URL",
                        example =
                                "https://{버킷이름}.s3.ap-northeast-2.amazonaws.com/missions/123e4567_image.jpg")
                String imageUrl,
        @Schema(description = "사보타주 여부", example = "true") Boolean sabotagedByOpponent,
        @Schema(
                        description = "사보타주 인증 사진 URL",
                        example =
                                "https://{버킷이름}.s3.ap-northeast-2.amazonaws.com/sabotage/987f6543_image.jpg")
